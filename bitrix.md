...
Затем создаем пользователя и на вкладке "ГРУППЫ" 
ставим галки на: 
Пользователи панели управления 
Редактор новостей 

Далее нужно дать доступ на чтение нашей группе к папке /bitrix/admin/ 
страница /bitrix/admin/fileman_access.php?lang=ru&site=&path=/bitrix&files[]=admin 
